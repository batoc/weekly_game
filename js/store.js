...
const Store = (() => {
    ...
    const DEFAULT_DATA = {
        ...
        jugadores: [
            { id: "ana", nombre: "Ana", avatar: "🦸‍♀️", color: "#ff6b35", pts: 0, nivel: 1, xp: 0, badges: [], stats: { proyectos_completados: 0, casos_resueltos: 0, semanas_100: 0, racha_actual: 0, poderes_usados: 0, votos_recibidos: 0 }},
            { id: "magda", nombre: "Magda", avatar: "🧙‍♂️", color: "#7b2ff7", pts: 0, nivel: 1, xp: 0, badges: [], stats: { proyectos_completados: 0, casos_resueltos: 0, semanas_100: 0, racha_actual: 0, poderes_usados: 0, votos_recibidos: 0 }},
            { id: "monica", nombre: "Monica", avatar: "🦹‍♀️", color: "#00d4aa", pts: 0, nivel: 1, xp: 0, badges: [], stats: { proyectos_completados: 0, casos_resueltos: 0, semanas_100: 0, racha_actual: 0, poderes_usados: 0, votos_recibidos: 0 }},
